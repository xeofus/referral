package store.zor.referral.utils;
...
public class UAgentInfo {
    ...
    public boolean detectBlackBerry() {
        return userAgent.contains(deviceBB) || httpAccept.contains(vndRIM);
    }
    ...
    public boolean detectMSIE6() {
        return userAgent.contains(msie60) && userAgent.indexOf(msie61) != -1;
    }
